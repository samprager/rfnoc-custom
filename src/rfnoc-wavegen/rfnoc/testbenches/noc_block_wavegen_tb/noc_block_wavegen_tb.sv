  ...
  ********************************************************/
  initial begin : tb_main
    ...
    ********************************************************/
    ...
    $display("Read WAVEGEN NOC ID: %16x", readback);
    ...
    ********************************************************/
    ...
    random_word = $random();
    tb_streamer.write_user_reg(sid_noc_block_wavegen, noc_block_wavegen.SR_TEST_REG_0, random_word);
    tb_streamer.read_user_reg(sid_noc_block_wavegen, 0, readback);
    $sformat(s, "User register 0 incorrect readback! Expected: %0d, Actual %0d", readback[31:0], random_word);
    `ASSERT_ERROR(readback[31:0] == random_word, s);
    random_word = $random();
    tb_streamer.write_user_reg(sid_noc_block_wavegen, noc_block_wavegen.SR_TEST_REG_1, random_word);
    tb_streamer.read_user_reg(sid_noc_block_wavegen, 1, readback);
    ...
    ********************************************************/
    // wavegen's user code is a loopback, so we should receive
